...
//border exists only if size is 10px
    render(){
        return (
            <div style={{border: this.props.border ? 'solid black .5px' : 'solid black 0' ,width: this.props.pixSize + 'px', height: this.props.pixSize + 'px', backgroundColor: this.props.pixel.color}}
